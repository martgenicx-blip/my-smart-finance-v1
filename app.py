...
st.markdown("""
    ...
    .balance-amount { color: #1c1c1e; font-size: 32px; font-weight: 800; letter-spacing: -1px; margin-bottom: 15px; }
    .stat-container { display: flex; gap: 10px; padding-top: 15px; border-top: 1px solid #f1f3f5; }
    .stat-box { flex: 1; padding: 12px; border-radius: 15px; background: #fafbfc; border-left: 4px solid #ddd; }
